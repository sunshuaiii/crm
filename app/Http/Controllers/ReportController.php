...
class ReportController extends Controller
{
    ...
    public function generateReport(Request $request)
    {
        ...
        if ($reportType == 'customerBehaviour') {
            $reportDatasets = $this->customerBehaviourReport($startDate, $endDate);
        } else if ($reportType == 'salesPerformance') {
            $reportDatasets = $this->salesPerformanceReport($startDate, $endDate);
        }
    ...
    private function customerBehaviourReport($startDate, $endDate)
    {
