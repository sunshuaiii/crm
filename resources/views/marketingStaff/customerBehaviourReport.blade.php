        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="section">
                    ...
                    <h6 class="section-description">Calculate and analyze the CLTV for different customer segments. CLTV is calculated as the sum of the revenue generated by each customer within the segment within the time period.</h6>
                    <h6 class="section-description">Identify high-value customers for targeted marketing efforts. High-value customers are those who have made the highest total purchases within the time period.</h6>
                    <div class="row justify-content-center">
                        <div class='col-md-6 mt-4'>
                ...
                <div class="section">
                    ...
                    <h6 class="section-description">Visualize the timelines of customer interactions over time to identify peak engagement periods within the time period. The interactions are the ticket submitted, coupons claimed and coupons redeemed customers.</h6>
