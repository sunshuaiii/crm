...
Route::group(['middleware' => 'auth:marketingStaff'], function () {
    ...
    Route::get('/marketingStaff/reportGeneration/customerBehaviour', [CustomerReportController::class, 'customerBehaviourReport'])->name('marketingStaff.customerBehaviourReport');
    Route::get('/marketingStaff/reportGeneration/salesPerformance', [SalesReportController::class, 'salesPerformanceReport'])->name('marketingStaff.salesPerformanceReport');
    Route::post('/marketingStaff/generateReport', [MarketingStaffController::class, 'generateReport'])->name('marketingStaff.generateReport');
